...
class CustomerControllerTest {
    ...
    void itShouldCreateCustomer_WithCustomerDTORequest() throws Exception {
        ...
        when(service.create(any(Request.class))).thenReturn(Map.of("id", UUID.randomUUID(), "full_name", request.name()));
    ...
    void itShouldUpdateCustomer_WithCustomerIdAndCustomerDTORequest() throws Exception {
        ...
        when(service.update(any(UUID.class), any(Request.class))).thenReturn(Map.of("id", id, "full_name", request.name()));
